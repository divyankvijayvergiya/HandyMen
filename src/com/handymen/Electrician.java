...
Database db;
	...
	b2=(Button) findViewById(R.id.electriadd);
	final MediaPlayer buttonsound1=MediaPlayer.create(Electrician.this, R.raw.button_click1);
		b2.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View arg0) {
				//buttonsound1.start();
				Intent b22=new Intent(Electrician.this,List.class);
				startActivity(b22);
				finish();
...
db=new Database(getApplicationContext());
		...
		ArrayList<String[]> arr=new ArrayList<String[]>(db.viewAlldetails2());
		...
		ListView li=(ListView)findViewById(R.id.listView2);
		li.setAdapter(list);
